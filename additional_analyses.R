...
# Phylogenetic ANOVA ----------------------------------------------------
phylANOVA(tree = pruned_tetrapodtree, y = log_bodymass_tiporder, x = classes_tiporder)
phylANOVA(tree = pruned_tetrapodtree, y = log_C_E_tiporder, x = classes_tiporder)
phylANOVA(tree = pruned_tetrapodtree, y = log_E_alpha_tiporder, x = classes_tiporder)
phylANOVA(tree = pruned_tetrapodtree, y = log_I_m_tiporder, x = classes_tiporder)

tetrapd_mvmorph <- mvgls(cbind(log_C_E_tiporder, log_E_alpha_tiporder, log_I_m_tiporder) ~ classes_tiporder,
                         tree = pruned_tetrapodtree, model = "lambda", error = TRUE)
summary(tetrapd_mvmorph)
tetrapod_test <- manova.gls(tetrapd_mvmorph)
